...
class _WorkoutPageState extends State<Workout> {
  ...
  //     final uri = Uri.parse(
  //         "http://192.168.242.67:3000/postroutes/saveworkoutdetails");
  ...
  if (token == null) {
    ...
    try {
      final uri =
          Uri.parse('http://192.168.29.112:3000/getroutes/getworkoutdetails');
...
Future<void> addWorkoutDetails(List<Map<String, Object>> list) async {
  ...
  try {
    ...
    final uri = Uri.parse("http://192.168.29.112:3000/postroutes/saveworkoutdetails");
    final response = await http.post(
      uri,
      headers: {
        'Content-Type': 'application/json',
